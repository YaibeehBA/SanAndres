...
<head>
    ...
    <title><?php echo $settings_r['titulo']?> - HOME</title>
    <style>
        .availability-form {
            margin-top: -50px;
            z-index: 2;
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
                <iframe class="w-100 rounded" height="320 px" src="<?php echo $contact_r['iframe'] ?>" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
