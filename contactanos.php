...
<head>
    ...
    <title><?php echo $settings_r['titulo']?> - CONTACTANOS</title>
            ...
            <div class="col-lg-6 col-md-6 px-4">
                <div class="bg-white rounded shadow p-4 ">
                    <form method="post">
                        ...
                        <button name="send" type="submit" class="btn custon-bg text-white mt-3 ">Enviar Mensaje</button>
    ...
    <?php
      if(isset($_POST['send']))
      {
        ...
        if($res==1)
        {
            ...
            alert('error','Servidor caido intente mas tarde!');
        }
